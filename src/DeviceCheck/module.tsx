...
import type { TDeviceCheck, TPlayIntegrity, TokenType } from "./types";
                ...
                if (type === "classic") {
                    ...
                    try {
                        ...
                        if (isPrepared) {
                            ...
                            return [
                                await PlayIntegrity?.requestStandardIntegrityToken(
                                    hash,
                                ),
                                hash,
                            ].join("|");
                        ...
                        console.error(
                            "Erro ao obter o token de integridade padrão:",
                            e,
                        );
                    }
                }
